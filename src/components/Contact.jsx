                    ...
                    <div className="container mx-auto px-4 lg:px-0">
                        <div className="grid grid-cols-1 items-center lg:grid-cols-2 gap-8">
                            ...
                            <div className=" flex flex-col gap-6 ">
                                ...
                                {/* <div className=" border border-[#E5E5E5]  rounded-3xl py-5 ps-8">
                                    <h3 className="text-xl font-semibold mb-2">Email</h3>
                                    <p className="text-[#222] text-base">support@reviewsgr.com</p>
                                    <p className="text-gray-600 text-sm">Well respond within 24 hours</p>
                                </div>
                                <div className=" border border-[#E5E5E5]  rounded-3xl py-5 ps-8">
                                    <h3 className="text-xl font-semibold mb-2">Live Chat</h3>
                                    <p className="text-gray-600 text-sm">Available 24/7</p>
                                    <p className="text-gray-600 text-sm">Instant support via WhatsApp</p>
                                </div> */}
                            </div>
                        </div>
                    </div>
