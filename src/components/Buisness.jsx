                ...
                <div className="grid lg:grid-cols-2  xl:grid-cols-4 grid-cols-2 xs:grid-cols-1 lg:gap-6 gap-5 mb-9">
                    {buisnessData.map((item, index) => (
                        <div
                            ...
                            <div
                                className={`bg-${item.icon_bg}  mx-auto lg:p-5 p-[12px] w-fit rounded-full mb-6 flex justify-center items-center transition-transform duration-300 group-hover:rotate-y-180`}
