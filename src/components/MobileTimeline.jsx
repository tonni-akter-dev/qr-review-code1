        ...
        <>
            <div className='relative'>
                <div className='flex justify-center  items-center'>
                    <img className='size-[52px]' src={step1} alt="" />
                </div>
            ...
            <div className='relative'>
                <div className='absolute left-[36px] z-50 top-[132px]'>
                    <img className='size-[52px]' src={step2} alt="" />
                </div>
                <div className='flex flex-col items-end gap-3 pt-7'>
                ...
                <div className='absolute top-0 left-[55px]'>
            ...
            <div className='relative'>
                ...
                <div className='flex items-center justify-center pt-[13px] ps-[80px]'>
                ...
                <div className='flex justify-between'>
                    <div className='  flex flex-col  text-center items-center gap-3 justify-center'>
                        ...
                        <div className='max-w-[177px] p-2 w-full bg-white shadow_custom rounded-lg relative z-50'>
